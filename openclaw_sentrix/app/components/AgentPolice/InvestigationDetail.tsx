    ...
    >
      ...
      >
        ...
        <div className="flex items-start justify-between px-4 py-3 border-b border-[var(--pixel-border)]">
          ...
          <button
            onClick={onClose}
            className="flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center text-[#4b5563] hover:text-white hover:bg-white/10 transition-colors cursor-pointer"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
